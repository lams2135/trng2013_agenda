...
TEST(AgendaServiceTest, userRegister) {
  ...
  EXPECT_TRUE(agendaService->userRegister("a", "a", "a@a.com", "a"));
  EXPECT_TRUE(agendaService->userRegister("b", "b", "b@b.com", "b"));
  EXPECT_TRUE(agendaService->userRegister("c", "c", "c@c.com", "c"));
  EXPECT_TRUE(agendaService->userRegister("d", "d", "d@d.com", "d"));
  EXPECT_FALSE(agendaService->userRegister("a", "b", "c@c.com", "d"));
  EXPECT_FALSE(agendaService->userRegister("b", "ee", "ff", "qq"));
  
  delete agendaService;
}

TEST(AgendaServiceTest, deleteUser) {
  AgendaService *agendaService = new AgendaService();
  EXPECT_TRUE(agendaService->userRegister("a", "a", "a@a.com", "a"));
  EXPECT_FALSE(agendaService->userRegister("a", "b", "c@c.com", "d"));
  EXPECT_TRUE(agendaService->deleteUser(User("a", "a", "a@a.com", "a")));
  EXPECT_TRUE(agendaService->userRegister("a", "a", "a@a.com", "a"));
...
TEST(AgendaServiceTest, createMeeting) {
  ...
  EXPECT_TRUE(agendaService->userRegister("a", "a", "a@a.com", "a"));
  EXPECT_TRUE(agendaService->userRegister("b", "b", "b@b.com", "b"));
  EXPECT_TRUE(agendaService->createMeeting("a", "owo", "b", "2012-02-02/12:12", "2012-02-02/13:13"));
  EXPECT_FALSE(agendaService->createMeeting("a", "wow", "b", "2012-02-02/12:12", "2012-02-02/13:13"));
  EXPECT_FALSE(agendaService->createMeeting("a", "owo", "b", "2012-03-03/12:12", "2012-03-03/13:13"));
  EXPECT_FALSE(agendaService->createMeeting("a", "wow", "c", "2012-03-03/12:12", "2012-03-03/13:13"));
  EXPECT_FALSE(agendaService->createMeeting("a", "wow", "b", "2012-02-02/13:12", "2012-02-02/14:14"));
  EXPECT_FALSE(agendaService->createMeeting("a", "owo", "b", "2013-02-31/13:13", "2013-2-31/14:14"));

  delete agendaService;
}

TEST(AgendaServiceTest, meetingQuery) {
  AgendaService *agendaService = new AgendaService();
  EXPECT_TRUE(agendaService->userRegister("a", "a", "a@a.com", "a"));
  EXPECT_TRUE(agendaService->userRegister("b", "b", "b@b.com", "b"));
  EXPECT_TRUE(agendaService->userRegister("c", "c", "c@c.com", "c"));
  EXPECT_TRUE(agendaService->createMeeting("a", "owo", "b", "2012-02-02/12:12", "2012-02-02/13:13"));
  EXPECT_TRUE(agendaService->createMeeting("a", "wow", "c", "2012-02-02/14:14", "2012-02-02/15:15"));
  EXPECT_TRUE(agendaService->meetingQuery("owo") != NULL);
  EXPECT_TRUE(agendaService->meetingQuery("wow") != NULL);
  EXPECT_TRUE(agendaService->meetingQuery("wothesuck") == NULL);
...
TEST(AgendaServiceTest, deleteMeeting) {
  ...
  EXPECT_TRUE(agendaService->createMeeting("a", "wow", "c", "2012-02-02/14:14", "2012-02-02/15:15"));
  EXPECT_TRUE(agendaService->meetingQuery("owo") != NULL);
  EXPECT_FALSE(agendaService->deleteMeeting("b", "owo"));
  EXPECT_TRUE(agendaService->deleteMeeting("a", "owo"));
  EXPECT_TRUE(agendaService->meetingQuery("owo") == NULL);
  EXPECT_TRUE(agendaService->meetingQuery("wow") != NULL);
  EXPECT_TRUE(agendaService->deleteMeeting("a", "wow"));
  EXPECT_TRUE(agendaService->meetingQuery("wow") == NULL);
